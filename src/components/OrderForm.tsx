    ...
    <div className="p-6 bg-slate-100 border rounded-md">
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div>
          ...
          {errors.firstname && (
            <p className="text-red-500 text-sm pt-1 m-0">{errors.firstname.message}</p>
          )}
        </div>
        ...
        <div>
          ...
          {errors.lastname && (
            <p className="text-red-500 text-sm pt-1 m-0">{errors.lastname.message}</p>
          )}
        </div>
        ...
        <div>
          ...
          {errors.organizationname && (
            <p className="text-red-500 text-sm pt-1 m-0">
        ...
        <div>
          ...
          />
          {errors.email && (
            <p className="text-red-500 text-sm pt-1 m-0">{errors.email.message}</p>
          )}
        </div>
